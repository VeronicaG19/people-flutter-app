abstract class UrlFailure {
  const UrlFailure();
  factory UrlFailure.empty() = UrlFailureEmpty;
  factory UrlFailure.invalid() = UrlFailureInvalid;
  ...
  factory UrlFailure.fromString(String value) {
    if (value == 'empty') {
      return UrlFailure.empty();
    }

    if (value == 'invalid') {
      return UrlFailure.invalid();
    }
